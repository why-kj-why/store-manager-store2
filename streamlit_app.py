...
def store_manager_app():
    ...
    store_questions = {
        ...
        "What is the Daily Sales Report (DSR) using our sales records for latest location of store THE PIKE OUTLETS on July 31, 2023?": {
        ...
        "Compare the average sales revenue for the store with latest location THE PIKE OUTLETS with the average sales revenue for all stores with Latest Country USA.": {
        ...
        "What were the sales during the 'Autumn/Winter' season for store with latest location THE PIKE OUTLETS?": {
        ...
        "What is the average number of units sold per transaction at the latest location of store THE PIKE OUTLETS?": {
